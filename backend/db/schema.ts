...
export const settlementCurrencyEnum = pgEnum("settlement_currency", [
  "usdc",
  "eurc",
]);
...
export const shipmentParticipants = pgTable(
  ...
  (table) => [
    unique("shipment_participant_unique").on(
      table.shipmentId,
      table.logisticsPartnerId,
    ),
  ],
);
...
export const shipmentParticipantsRelations = relations(
...
export const paymentObligationsRelations = relations(
  paymentObligations,
  ({ one }) => ({
